...
<head>
    ...
    <title>@yield('pageTitle') - Medicine Management system</title>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        ...
                                        <div class="col-xs-12">
                                            <div id="new_arrivals_megamenu" class="row">
                                                <div><img src="{{ URL::asset('assets/img/ecom/products/39_Ie8T.jpeg') }}" class="col-sm-6 col-md-4 max-h-200" alt=""></div>
                                                <div><img src="{{ URL::asset('assets/img/ecom/products/39_8wMD.jpeg') }}" class="col-sm-6 col-md-4 max-h-200" alt=""></div>
                                                <div><img src="{{ URL::asset('assets/img/ecom/products/39_JnFC.jpeg') }}" class="col-sm-6 col-md-4 max-h-200" alt=""></div>
                                                <div><img src="{{ URL::asset('assets/img/ecom/products/2830_S4ql.jpeg') }}" class="col-sm-6 col-md-4 max-h-200" alt=""></div>
                                                <div><img src="{{ URL::asset('assets/img/ecom/products/4107_PPxC.jpeg') }}" class="col-sm-6 col-md-4 max-h-200" alt=""></div>
                                                <div><img src="{{ URL::asset('assets/img/ecom/products/5764_YK7g.jpeg') }}" class="col-sm-6 col-md-4 max-h-200" alt=""></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                ...
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown avatar-menu">
                        <a href="javascript:void(0)" data-toggle="dropdown" aria-expanded="false">
								<span class="meta">
									<span class="avatar">
										<img src="{{ URL::asset('assets/img/profiles/02.jpg') }}" alt="" class="img-circle max-w-35">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-group ">
                                            <li class="list-group-item ">
                                                <span class="pull-left"><img src="{{ URL::asset('assets/img/profiles/11.jpg') }}" alt="" class="img-circle max-w-40 m-r-10 "></span>
                            ...
                            <li>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-group ">
                                            <li class="list-group-item ">
                                                <span class="pull-left"><img src="{{ URL::asset('assets/img/profiles/07.jpg') }}" alt="" class="img-circle max-w-40 m-r-10 "></span>
                                                <div class="list-group-item-body">
                            ...
                            <li>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-group ">
                                            <li class="list-group-item ">
                                                <span class="pull-left"><img src="{{ URL::asset('assets/img/profiles/05.jpg') }}" alt="" class="img-circle max-w-40 m-r-10 "></span>
                                                <div class="list-group-item-body">
        ...
        <div id="logo_wrapper">
            <ul>
                <li class="logo-icon">
                    <a href="index.html">
                        <div class="logo">
                            <img src="{{ URL::asset('assets/img/logo/logo-icon.png') }}" alt="Logo">
                        </div>
                    ...
                    <div class="tab-pane fade active in" id="sidebar_chat">
                        ...
                        <ul class="list-group p-0">
                            ...
                            <li class="list-group-item" data-chat="open" data-chat-name="Ashley Ford">
                                <span class="pull-left"><img src="{{ URL::asset('assets/img/profiles/18.jpg') }}" alt="" class="img-circle max-w-40 m-r-10 "></span>
                                <i class="badge mini success status"></i>
                                <div class="list-group-item-body">
                        ...
                        <ul class="list-group p-0">
                            <li class="list-group-item" data-chat="open" data-chat-name="Mike Jones">
                                <span class="pull-left"><img src="{{ URL::asset('assets/img/profiles/03.jpg') }}" alt="" class="img-circle max-w-40 m-r-10 "></span>
                            ...
                            <li class="list-group-item" data-chat="open" data-chat-name="Nikki Clark">
                                <span class="pull-left"><img src="{{ URL::asset('assets/img/profiles/06.jpg') }}" alt="" class="img-circle max-w-40 m-r-10 "></span>
                                <i class="badge mini warning status"></i>
                                <div class="list-group-item-body">
                            ...
                            <li class="list-group-item" data-chat="open" data-chat-name="Jason Kendall">
                                <span class="pull-left"><img src="{{ URL::asset('assets/img/profiles/15.jpg') }}" alt="" class="img-circle max-w-40 m-r-10 "></span>
                                <i class="badge mini warning status"></i>
                                <div class="list-group-item-body">
                        ...
                        <ul class="list-group p-0">
                            <li class="list-group-item" data-chat="open" data-chat-name="Josh Hemsley">
                                <span class="pull-left"><img src="{{ URL::asset('assets/img/profiles/16.jpg') }}" alt="" class="img-circle max-w-40 m-r-10 "></span>
                            ...
                            <li class="list-group-item" data-chat="open" data-chat-name="James Hart">
                                <span class="pull-left"><img src="{{ URL::asset('assets/img/profiles/09.jpg') }}" alt="" class="img-circle max-w-40 m-r-10 "></span>
                                <i class="badge mini danger status"></i>
                                <div class="list-group-item-body">
                    ...
                    <div class="tab-pane fade" id="sidebar_settings">
                        <div class="color-container">
                            ...
                            <div class="row">
                                <div class="col-xs-3 p-0">
                                    <div class="color-option-check">
                                        <label data-load-css="{{ URL::asset('assets/css/theme-a.css') }}">
                                ...
                                <div class="col-xs-3 p-0">
                                    <div class="color-option-check">
                                        <label data-load-css="{{ URL::asset('assets/css/theme-b.css') }}">
                                ...
                                <div class="col-xs-3 p-0">
                                    <div class="color-option-check">
                                        <label data-load-css="{{ URL::asset('assets/css/theme-c.css') }}">
                                            <input type="radio" name="setting-theme">
                                            <span class="icon-check"></span>
                                            <span class="split">
                                ...
                                <div class="col-xs-3 p-0">
                                    <div class="color-option-check">
                                        <label data-load-css="{{ URL::asset('assets/css/theme-d.css') }}">
                                            <input type="radio" name="setting-theme">
                                            <span class="icon-check"></span>
                                            <span class="split">
                            ...
                            <div class="row m-t-20">
                                <div class="col-xs-3 p-0">
                                    <div class="color-option-check">
                                        <label data-load-css="{{ URL::asset('assets/css/theme-e.css') }}">
                                            <input type="radio" name="setting-theme" checked="checked">
                                            <span class="icon-check"></span>
                                            <span class="split">
                                ...
                                <div class="col-xs-3 p-0">
                                    <div class="color-option-check">
                                        <label data-load-css="{{ URL::asset('assets/css/theme-f.css') }}">
                                            <input type="radio" name="setting-theme">
                                            <span class="icon-check"></span>
                                            <span class="split">
                                ...
                                <div class="col-xs-3 p-0">
                                    <div class="color-option-check">
                                        <label data-load-css="{{ URL::asset('assets/css/theme-g.css') }}">
                                            <input type="radio" name="setting-theme">
                                            <span class="icon-check"></span>
                                            <span class="split">
                                ...
                                <div class="col-xs-3 p-0">
                                    <div class="color-option-check">
                                        <label data-load-css="{{ URL::asset('assets/css/theme-h.css') }}">
                                            <input type="radio" name="setting-theme">
                                            <span class="icon-check"></span>
                                            <span class="split">
