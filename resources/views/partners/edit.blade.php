@extends('layouts.app')
@section('pageTitle', 'modify Partners')
@section('content')
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::open(['route' => ['partners.update', 'id' => $data->id], 'files' => true, 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
                            <div class="form-group{{ $errors->has('brand_name') ? ' has-error' : '' }}">
                                {{Form::label('brand_name', trans('Tên Đối tác'), ['class' => 'col-sm-2 control-label'])}}
                                <div class="col-sm-10">
                                    {{ Form::text('brand_name', $data->brand_name,
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <img src="{{$data->brand_image}}" width="400" height="200" />
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('district') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('district', $data->district,
                            ...
                            <div class="form-group{{ $errors->has('mobile_phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('mobile_phone', $data->mobile_phone,
                            ...
                            <div class="form-group{{ $errors->has('home_phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('home_phone', $data->home_phone,
                            ...
                            <div class="form-group{{ $errors->has('business_registration_number') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('business_registration_number', $data->business_registration_number,
                            ...
                            <div class="form-group">
                                {{Form::label('', trans(''), ['class' => 'col-sm-2 control-label'])}}
                                <div class="col-sm-10">
                                    <img src="{{$data->business_registration_image}}" width="400" height="200" />
                                </div>
                            </div>
                            ...
                            <div class="form-group is-empty{{ $errors->has('establish_date') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('establish_date', $data->establish_date,
                            ...
                            <div class="form-group">
                                {{Form::label('', trans(''), ['class' => 'col-sm-2 control-label'])}}
                                <div class="col-sm-10">
                                    <img src="{{$data->registration_image}}" width="400" height="200" />
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('tax_number') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('tax_number', $data->tax_number,
                            ...
                            <div class="form-group{{ $errors->has('vice_gerent') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('vice_gerent', $data->vice_gerent,
                            ...
                            <div class="form-group{{ $errors->has('contact_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('contact_name', $data->contact_name,
                            ...
                            <div class="form-group{{ $errors->has('contact_mobile_phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('contact_mobile_phone', $data->contact_mobile_phone,
                                            [   'placeholder' => trans('Ex: 0983251253'),
                                                'data-rule-required' => 'true',
                                                'minlength' => '10',
                                                'class' => 'form-control',
                            ...
                            <div class="form-group{{ $errors->has('contact_home_phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::text('contact_home_phone', $data->contact_home_phone,
                                            [   'placeholder' => trans('Ex: 0243.256.265'),
                                                'data-rule-required' => 'true',
                                                'minlength' => '10',
                                                'class' => 'form-control',
